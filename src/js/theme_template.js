(function () {
  ...
  const initNeonDreams = (disableGlow, obs) => {
    ...
    newStyleTag.setAttribute("id", "dark-synthwave-84-theme-styles");
    newStyleTag.innerText = updatedThemeStyles.replace(/(\r\n|\n|\r)/gm, '');
    document.body.appendChild(newStyleTag);
    
    console.log('Dark Synthwave \'84: NEON DREAMS initialised!');
  ...
  const watchForBootstrap = function(mutationsList, observer) {
    for(let mutation of mutationsList) {
          if (mutation.type === 'attributes') {
            ...
            const isUsingSynthwave = document.querySelector('[class*="Xenas-dark-synthwave-vscode-themes"]');
